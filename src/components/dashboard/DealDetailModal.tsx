  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        <div className="flex gap-4 p-4 bg-[#0A1020] border border-[#182643] rounded-xl">
          <div className="w-16 h-16 rounded-lg bg-[#14203B] border border-[#1E2E50] overflow-hidden shrink-0 flex items-center justify-center">
            <img
              src={offer.imageUrl}
              alt={offer.name}
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="text-xs text-[#8E9BAE]">• {offer.foundAt}</span>
            </div>
            <h4 className="text-sm font-semibold text-[#E6E8EC] mt-1 leading-snug">
              {offer.name}
            </h4>
            <div className="flex items-center gap-3 mt-2">
              ...
              <span className="text-xs text-emerald-400 font-mono-numeric font-medium bg-emerald-500/10 px-1.5 py-0.5 rounded border border-emerald-500/20">
                -{offer.discountPercentage}%
              </span>
              <span className="text-xs text-[#00C2FF] font-mono-numeric font-semibold ml-auto">
        ...
        <div className="bg-[#0D1526] border border-[#1B2947] rounded-xl p-4">
          <div className="flex items-center justify-between pb-3 border-b border-[#162340]">
            <div className="flex items-center gap-2.5">
              <div className="flex items-center justify-center font-mono-numeric font-extrabold text-base w-9 h-9 rounded-lg bg-[#1E5EFF]/20 text-[#00C2FF] border border-[#1E5EFF]/40">
                {offer.score.total}
              </div>
              <div>
                <span className="text-sm font-semibold text-[#E6E8EC]">
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            {/* Queda de Preço */}
            <div className="p-3 bg-[#080E1C] rounded-lg border border-[#15213D]">
              ...
              <div className="w-full bg-[#14203B] rounded-full h-1.5 mt-2">
                <div
                  className="bg-[#00C2FF] h-full rounded-full"
                  style={{ width: `${offer.score.priceDropScore}%` }}
                />
              </div>
              <span className="text-xs text-[#8E9BAE] mt-1.5 block">
            ...
            <div className="p-3 bg-[#080E1C] rounded-lg border border-[#15213D]">
              ...
              <div className="w-full bg-[#14203B] rounded-full h-1.5 mt-2">
                <div
                  className="bg-[#1E5EFF] h-full rounded-full"
        ...
        <div className="bg-[#080E1C] border border-[#172545] rounded-xl p-4">
          <div className="flex items-center justify-between pb-2 border-b border-[#14203B] mb-2">
            <span className="text-xs font-semibold text-[#E6E8EC] flex items-center gap-1.5">
            ...
            <button
              type="button"
              onClick={handleCopy}
              className="text-xs text-[#00C2FF] hover:text-[#38BDF8] flex items-center gap-1 transition-colors font-medium"
            >
              {copied ? (
                <>
          ...
          <pre className="text-xs font-mono text-[#8E9BAE] whitespace-pre-wrap leading-relaxed max-h-36 overflow-y-auto bg-[#060A14] p-3 rounded-lg border border-[#121B30]">
            {generatedPostCopy}
          </pre>
        </div>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-[#162340]">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-xs text-[#8E9BAE] hover:text-[#E6E8EC] flex items-center gap-1 transition-colors"
          >
