...
${offer.linkAfiliado}`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      {/* Drawer Container */}
      <div className="relative w-full max-w-xl bg-[#0A0F1C] border-l border-[#1B2947] h-full flex flex-col z-10 shadow-2xl animate-in slide-in-from-right duration-250">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="flex gap-4 p-4 bg-[#0B1324] border border-[#162340] rounded-xl">
            <div className="w-20 h-20 rounded-lg overflow-hidden bg-[#070C18] border border-[#182747] shrink-0">
              <img
                src={offer.imageUrl}
                alt={offer.name}
            ...
            <div className="min-w-0 flex-1 space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-[#8E9BAE]">{offer.category}</span>
              </div>
              <h4 className="text-sm font-semibold text-[#E6E8EC] leading-snug">
                {offer.name}
              </h4>
              <p className="text-xs text-[#64748B]">
                Loja: <span className="text-[#8E9BAE]">{offer.storeName}</span>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <h5 className="text-xs font-bold text-[#E6E8EC] uppercase tracking-wider">
              Preço & Economia
            </h5>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              <div className="p-3 bg-[#0B1324] border border-[#162340] rounded-lg">
                <span className="text-[11px] text-[#8E9BAE] block">Preço anterior</span>
                <span className="text-xs font-mono-numeric text-[#8E9BAE] line-through mt-0.5 block">
                  R$ {offer.originalPrice.toFixed(2).replace('.', ',')}
                </span>
              </div>
              <div className="p-3 bg-[#0B1324] border border-[#162340] rounded-lg">
                <span className="text-[11px] text-[#8E9BAE] block">Preço atual</span>
                <span className="text-sm font-bold font-mono-numeric text-[#E6E8EC] mt-0.5 block">
                  R$ {offer.price.toFixed(2).replace('.', ',')}
                </span>
              </div>
              <div className="p-3 bg-[#0B1324] border border-[#162340] rounded-lg">
                <span className="text-[11px] text-[#8E9BAE] block">Economia</span>
                <span className="text-xs font-bold font-mono-numeric text-emerald-400 mt-0.5 block">
                  R$ {economy.toFixed(2).replace('.', ',')}
                </span>
              </div>
              <div className="p-3 bg-[#0B1324] border border-[#162340] rounded-lg">
                <span className="text-[11px] text-[#8E9BAE] block">Desconto</span>
                <span className="text-xs font-bold font-mono-numeric text-[#00C2FF] mt-0.5 block">
                  {offer.discountPercentage}% OFF
                </span>
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2.5">
              <div className="p-3 bg-[#0B1324] border border-[#162340] rounded-lg text-center">
                <span className="text-[11px] text-[#8E9BAE] block">Avaliação</span>
                <div className="flex items-center justify-center gap-1 mt-1">
                  <Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" />
                  <span className="text-sm font-bold font-mono-numeric text-amber-300">
                    {offer.rating.toFixed(1).replace('.', ',')}
                  </span>
                </div>
              </div>
              <div className="p-3 bg-[#0B1324] border border-[#162340] rounded-lg text-center">
                <span className="text-[11px] text-[#8E9BAE] block">Avaliações</span>
                <span className="text-sm font-bold font-mono-numeric text-[#E6E8EC] mt-1 block">
                  {offer.reviewCount.toLocaleString('pt-BR')}
                </span>
              </div>
              <div className="p-3 bg-[#0B1324] border border-[#162340] rounded-lg text-center">
                <span className="text-[11px] text-[#8E9BAE] block">Vendas</span>
                <span className="text-sm font-bold font-mono-numeric text-[#38BDF8] mt-1 block">
                  {offer.salesVolume}+
                </span>
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="p-3.5 bg-[#0B1324] border border-[#162340] rounded-xl space-y-3">
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <div>
                  <span className="text-[11px] text-[#8E9BAE] block mb-1">
                ...
                <div>
                  ...
                  <span className="text-xs font-mono-numeric text-[#E6E8EC] bg-[#070C18] px-2 py-1 rounded border border-[#182747] inline-block">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2.5 border-t border-[#14203B]">
                <div>
                  <span className="text-[11px] text-[#8E9BAE] block">
                    Comissão Estimada
                  </span>
                  <span className="text-base font-bold font-mono-numeric text-emerald-400 mt-0.5 block">
                    R$ {offer.commissionAmount.toFixed(2).replace('.', ',')}
                  </span>
                </div>
                <div>
                  <span className="text-[11px] text-[#8E9BAE] block">Taxa de Comissão</span>
                  <span className="text-base font-bold font-mono-numeric text-[#E6E8EC] mt-0.5 block">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 h-8.5 px-3 bg-[#070C18] border border-[#182747] rounded-lg text-xs font-mono-numeric text-[#8E9BAE] select-all focus:outline-none"
                  />
                  <Button
                    size="xs"
                    variant="outline"
          ...
          <div className="space-y-2.5">
            ...
            {/* Breakdown Bars */}
            <div className="p-3.5 bg-[#0B1324] border border-[#162340] rounded-xl space-y-2.5">
              <div className="space-y-1">
                <div className="flex justify-between text-xs">
                  <span className="text-[#8E9BAE]">Desconto</span>
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs">
                  <span className="text-[#8E9BAE]">Avaliação</span>
                  <span className="font-mono-numeric font-semibold text-[#E6E8EC]">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs">
                  <span className="text-[#8E9BAE]">Vendas</span>
                  <span className="font-mono-numeric font-semibold text-[#E6E8EC]">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs">
                  <span className="text-[#8E9BAE]">Comissão</span>
                  <span className="font-mono-numeric font-semibold text-[#E6E8EC]">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs">
                  <span className="text-[#8E9BAE]">Preço</span>
                  <span className="font-mono-numeric font-semibold text-[#E6E8EC]">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs">
                  <span className="text-[#8E9BAE]">Oferta / Cupom</span>
                  <span className="font-mono-numeric font-semibold text-[#E6E8EC]">
              ...
              <div className="pt-2 border-t border-[#14203B] flex items-center justify-between text-xs">
                <span className="font-bold text-[#E6E8EC]">Total Calculado</span>
                <span className="font-mono-numeric font-bold text-[#00C2FF]">
          ...
          <div className="space-y-2">
            ...
            <div className="p-3.5 bg-[#070C18] border border-[#162340] rounded-xl text-xs font-sans text-[#E6E8EC] whitespace-pre-wrap leading-relaxed select-all">
              {copyText}
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-[#14203B] bg-[#070C18] flex items-center justify-between gap-2 shrink-0">
          ...
          <Button
            ...
            className="text-xs font-semibold px-5 shadow-sm shadow-[#1E5EFF]/30"
          >
            Publicar oferta
          </Button>
        </div>
